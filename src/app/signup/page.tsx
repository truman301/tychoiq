      ...
      <div className="w-full max-w-sm">
        <div className="mb-6 flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            <h1 className="font-display text-xl font-semibold">Create your Tycho IQ account</h1>
            <p className="mt-1 text-sm text-muted-foreground">You'll get your own private workspace</p>
          </div>
        </div>
        <Card>
